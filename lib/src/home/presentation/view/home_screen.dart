...
class _HomeScreenState extends State<HomeScreen> {
  ...
  SfCartesianChart _buildCustomizedLineChart() {
    return SfCartesianChart(
      ...
      title: const ChartTitle(text: 'Capital investment as a share of exports'),
      ...
      series: <CartesianSeries<_ChartData, DateTime>>[
        ...
        //     _ChartData(DateTime(2019, 6), 1.5),
        //     _ChartData(DateTime(2020, 2), 5.5),
        //     _ChartData(DateTime(2020, 8), 4),
        //   ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _buildCustomizedLineChart(),
    );
  }
}
